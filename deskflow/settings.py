...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "deskflow"),
...
# Ticket attachments land here; they are only served through the authenticated
# download endpoint, never as public MEDIA urls.
...
# not per-process. Tests use local memory so runs don't leak state into Redis.
CACHES = {
    "default": {
